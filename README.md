...
This repository contains the package with main logger functionality.
...
In order to install and use the linked dependencies for `diia-logger` the following command can be used:
